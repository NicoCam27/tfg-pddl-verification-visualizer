...
def create_action_move_conveyor(drone, conveyor, arm, origin, destination, start, duration = 1, cost = 1, description=""):
    ...
    return Action(start=start, duration=duration, description=description, action_type="move_conveyor", data=data, on_finish=lambda: drone.move_conveyor(conveyor, arm, origin, destination, duration, cost))
