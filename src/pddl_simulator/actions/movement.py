...
def create_action_move(drone, origin, destination, start, duration = 1, cost = 1, description=""):
    ...
    return Action(start=start, duration=duration, description=description, action_type="move", data=data, on_start=lambda: drone.move(origin, destination, duration, cost))
